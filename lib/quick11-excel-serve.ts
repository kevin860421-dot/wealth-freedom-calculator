...
export const QUICK11_EXCEL_DOWNLOAD_AS = "quick11-loan-dti-template.xlsx";
...
export function quick11ExcelDownloadResponse(buffer: Buffer, cacheControl = "public, max-age=3600"): NextResponse {
