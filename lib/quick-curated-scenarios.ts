...
export const QUICK_CURATED_SCENARIOS: Record<number, QuickCuratedScenario[]> = {
  ...
  7: [
    { label: "月投 2 萬・房貸 30 年", query: { m: "20000", y: "30" } },
    { label: "月投 3 萬・房貸 20 年", query: { m: "30000", y: "20" } },
    { label: "月投 1.5 萬・房貸 25 年", query: { m: "15000", y: "25" } },
    { label: "月投 2 萬・房貸 15 年", query: { m: "20000", y: "15" } },
    { label: "月投 1 萬・房貸 20 年", query: { m: "10000", y: "20" } },
    { label: "月投 2.5 萬・房貸 30 年", query: { m: "25000", y: "30" } },
    { label: "月投 3 萬・房貸 25 年", query: { m: "30000", y: "25" } },
    { label: "月投 2 萬・房貸 10 年", query: { m: "20000", y: "10" } },
  ],
  8: [
