...
import { getQuickFaqs, getQuickFaqSummaryLabel } from "@/lib/quick-seo-faq-data";
...
export function QuickFaqSection({ id }: { id: number }) {
  ...
  return (
    <details style={DETAILS_STYLE}>
      <summary style={SUMMARY_STYLE}>{getQuickFaqSummaryLabel(id)}</summary>
      <section aria-labelledby={`quick-${id}-faq-heading`} style={{ marginTop: 12 }}>
        <h2
