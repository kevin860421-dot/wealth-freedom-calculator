...
export const TICKER_PRESETS: TickerPreset[] = [
    ...
    {
      id: "00631R",
      label: "元大台灣50正2（00631R）- ETF - 不配息 - 參考",
      annualReturn: 15,
    ...
    {
      id: "00679B",
      label: "元大美債20年（00679B）- ETF - 季配 - 參考",
      annualReturn: 4.5,
      frequency: "quarter" as TickerFrequency,
      price: 30,
      dividendPerPeriod: 0.24,
      dividendYieldPct: 3.2,
      stockDividendPct: 1.3,
      dividendMonths: [1, 4, 7, 10],
      ratio54c: "0"
    },
    {
    ...
    {
      id: "00929",
      label: "復華台灣科技優息（00929）- ETF - 月配 - 參考",
      annualReturn: 7,
    ...
    {
      id: "00940",
      label: "元大台灣價值高息（00940）- ETF - 月配 - 參考",
      annualReturn: 6.8,
      frequency: "month" as TickerFrequency,
      price: 9.5,
    ...
    {
      id: "VOO",
      label: "Vanguard標普500 (VOO) - ETF - 季配 - 參考",
      annualReturn: 9,
      frequency: "quarter" as TickerFrequency,
      price: 500,
      dividendPerPeriod: 1.8,
      dividendYieldPct: 1.4,
      stockDividendPct: 7.6,
      dividendMonths: [3, 6, 9, 12],
      ratio54c: "0"
    },
    {
    ...
    {
      id: "00936",
      label: "台新永續高息中小（00936）- ETF - 月配 - 參考",
      annualReturn: 7,
      frequency: "month" as TickerFrequency,
      price: 19,
    ...
    {
      id: "00943",
      label: "兆豐電子高息等權（00943）- ETF - 月配 - 參考",
      annualReturn: 7.5,
      frequency: "month" as TickerFrequency,
      price: 20,
      dividendPerPeriod: 0.24,
